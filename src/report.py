...
<html>
  ...
  <body>
    ...
    #Write footer
    #If the Git commit is interesting enough to include, modify configure.ac:
    #Replace 0.1.0 in AC_INIT with:
    #    [m4_esyscmd_s([git describe --tags --always --match [0-9]* 2> /dev/null || date +%F])]
    #Source: http://vincent.bernat.im/en/blog/2013-lldpd-0.7.1.html#automated-version
    if args.fsnversion:
        maybe_version = ", version " + args.fsnversion
    else:
        maybe_version = ""
    print("""\
    <footer>
      <p>Generated by FSNView%s.</p>
    </footer>
  </body>
</html>""" % maybe_version)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fsnversion", help="Version of FSNView.")
